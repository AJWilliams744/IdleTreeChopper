...
#define UE_PROJECT_NAME IdleTreeChopper
#define UE_TARGET_NAME IdleTreeChopperEditor
#define UE_MODULE_NAME "RiderDebuggerSupport"
...
#define RIDERDEBUGGERSUPPORT_API DLLEXPORT
